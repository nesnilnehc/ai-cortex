...
| 自引用任务→资产 | **Skill**：撰写/修订 AGENTS.md → [write-agents-entry](skills/write-agents-entry/SKILL.md)；设计/重构 Skill → [refine-skill-design](skills/refine-skill-design/SKILL.md)；生成 README → [generate-standard-readme](skills/generate-standard-readme/SKILL.md)。**Rule**：中文写作规范 → [chinese-technical-standard](rules/chinese-technical-standard.md)。**Command**：快捷生成 README → [/readme](commands/readme.md)。完整列表见 [skills/INDEX.md](skills/INDEX.md)、[rules/INDEX.md](rules/INDEX.md)、[commands/INDEX.md](commands/INDEX.md) |
