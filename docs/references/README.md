...
| [guides/protocols-quickstart.md](../guides/protocols-quickstart.md) | Getting a protocol in front of an agent: where protocols live, and the checklist before emitting one |
| [guides/protocols-usage.md](../guides/protocols-usage.md) | Discovering, installing and using the domain protocol specs, and how a protocol version is upgraded |
| [guides/protocols-agent-usage.md](../guides/protocols-agent-usage.md) | How an agent discovers, injects, applies and verifies a protocol without the user reading it by hand |
