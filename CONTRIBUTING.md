...
| `python3 scripts/check-findings-contract.py` | A review Skill's prose changed — a Skill that emits findings must cite `specs/findings-list.md` for what a finding carries, not restate the list |
