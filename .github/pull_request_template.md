...
- [ ] If derived from an external skill: the source, the pinned version and the licence are registered in `skills/SOURCES.yaml`, and that licence is compatible with this repository's MIT
