...
This skill scans project `docs/` structure, confirms paths via dialogue, and produces `docs/ARTIFACT_NORMS.md` and optionally `.ai-cortex/artifact-norms.yaml`. Other document-producing skills (capture-work-items, brainstorm-design, assess-doc-readiness) read these norms to align output paths.
...
- `bootstrap-docs`: Full docs bootstrap; discover-document-norms focuses on norms only
- `assess-doc-readiness`: Assess doc readiness; discover-document-norms defines norms
- `validate-doc-artifacts`: Validate docs against norms after norms are established
