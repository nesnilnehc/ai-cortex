...
**Scope**: All 38 skills under `skills/` (validate-doc-artifacts merged into assess-docs in 2026-03)
...
- **align-planning**: overlaps with assess-docs, run-checkpoint, align-architecture (routing/handoff by design); **market_position**: differentiated.
...
- **run-checkpoint** (orchestrator): overlaps with review-code orchestrator at control-plane level; **market_position**: differentiated.
...
### 6.10 Curation run (2026-03-06, discover-docs-norms, validate-doc-artifacts)
...
2. **No urgent changes**: 40 validated; no archive candidates.
3. **Overlaps by design**: Atomic review skills overlap with their orchestrator (review-code); analyze-requirements and design-solution form an intentional upstream/downstream pair.
4. **Curation run (2026-03-10)**: align-architecture added (Quality 20); 40 validated. prune-content removed (2026-03-16). No further changes recommended.
