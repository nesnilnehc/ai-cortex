...
| [define-mission](./define-mission/SKILL.md) | documentation, workflow | `1.1.0` | stable | 定义项目或组织的根本目的；回答项目为何存在；产出 mission 陈述并持久化到 docs。. |
| [define-vision](./define-vision/SKILL.md) | documentation, workflow | `1.1.0` | stable | 定义项目旨在创造的长远未来；回答我们在构建什么未来；产出 vision 陈述并持久化到 docs。. |
