...
| [run-repair-loop](./run-repair-loop/SKILL.md) | automation, devops, eng-standards, optimization | `1.1.0` | stable | Iteratively review, run tests, and apply targeted fixes until issues are resolved (or a stop condition is reached). |
| [bootstrap-docs](./bootstrap-docs/SKILL.md) | documentation, eng-standards, writing | `1.1.1` | stable | Bootstrap or adapt project docs from project-documentation-template; Initialize or Adjust modes; repeatable; strict kebab-case naming. |
...
| [align-planning](./align-planning/SKILL.md) | workflow, eng-standards, documentation | `1.3.0` | stable | Perform post-task traceback, typed drift detection, and top-down recalibration to keep planning (goals, requirements, milestones, roadmap) aligned with task execution. |
| [align-architecture](./align-architecture/SKILL.md) | workflow, eng-standards, documentation | `1.2.0` | stable | Verify architecture and design documents against code; produce Architecture Compliance Report when implementation diverges from ADR or design decisions. |
| [assess-doc-readiness](./assess-doc-readiness/SKILL.md) | documentation, eng-standards, workflow | `1.1.0` | stable | Assess doc evidence readiness across project layers, prioritize gaps, and produce a minimum-fill plan for reliable AI-assisted governance. |
| [run-checkpoint](./run-checkpoint/SKILL.md) | workflow, automation, eng-standards | `1.3.0` | stable | Analyze project state and produce next-action plan; Phase 0.5 Planning Readiness Gate when docs missing; then alignment and output-driven follow-ups; single cycle report. |
| [validate-doc-artifacts](./validate-doc-artifacts/SKILL.md) | documentation, eng-standards, workflow | `1.0.0` | stable | Validate docs against project artifact norms; output findings list for path, naming, and front-matter compliance. |
