...
| [align-execution](./align-execution/SKILL.md) | workflow, eng-standards, documentation | `1.1.0` | stable | Perform post-task traceback, typed drift detection, and top-down recalibration to keep execution aligned with goals, requirements, milestones, and roadmap (planning layer only). |
