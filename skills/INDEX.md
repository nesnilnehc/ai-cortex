...
| [review-code](./review-code/SKILL.md) | eng-standards | `2.4.0` | Orchestrator: run scope → language → framework → library → cognitive review skills in order and aggregate findings into one report. |
