...
| [align-planning](./align-planning/SKILL.md) | workflow, eng-standards, documentation | `1.2.0` | stable | Perform post-task traceback, typed drift detection, and top-down recalibration to keep planning (goals, requirements, milestones, roadmap) aligned with task execution. |
| [align-architecture](./align-architecture/SKILL.md) | workflow, eng-standards, documentation | `1.1.0` | stable | Verify architecture and design documents against code; produce Architecture Compliance Report when implementation diverges from ADR or design decisions. |
| [assess-doc-readiness](./assess-doc-readiness/SKILL.md) | documentation, eng-standards, workflow | `1.0.0` | stable | Assess doc evidence readiness across project layers, prioritize gaps, and produce a minimum-fill plan for reliable AI-assisted governance. |
| [run-checkpoint](./run-checkpoint/SKILL.md) | workflow, automation, eng-standards | `1.2.0` | stable | Analyze project state and produce next-action plan; Phase 0.5 Planning Readiness Gate when docs missing; then alignment and output-driven follow-ups; single cycle report. |
