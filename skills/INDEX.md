...
| [align-execution](./align-execution/SKILL.md) | workflow, eng-standards, documentation | `1.0.0` | stable | Perform post-task traceback, typed drift detection, and top-down recalibration to keep execution aligned with goals, requirements, architecture, milestones, and roadmap. |
