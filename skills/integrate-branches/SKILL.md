...
If the user's request already names the branches or says `all`, use that selection. Otherwise ask:
...
Consult [worked examples](references/examples.md) for mixed worktrees, dirty trees, or wrong invocation context.
