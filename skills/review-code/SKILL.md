...
tags: [eng-standards]
related_skills: [review-diff, review-codebase, review-dotnet, review-java, review-go, review-powershell, review-sql, review-vue, review-security, review-performance, review-architecture]
version: 2.5.0
license: MIT
...
- If language/framework is not explicit and cannot be inferred from the files in scope, **offer choices** ([.NET] [Java] [Go] [PowerShell] [SQL] [Vue] [Skip]); if still unclear, skip and **note the skip** in the final summary.
...
| **Language / framework** | **Infer from files in scope** | If unclear, offer choices: [.NET] [Java] [Go] [PowerShell] [SQL] [Vue] [Skip]; do not ask user to type. |
...
| **Language / framework** | Cannot infer from files | Offer: *[.NET] [Java] [Go] [PowerShell] [SQL] [Vue] [Skip]* — user picks one; if Skip or none match, skip and note in summary. |
...
- **When performing this skill, sequentially apply:**
  ...
  2. review-dotnet **or** review-java **or** review-go **or** review-powershell **or** review-sql (language, optional)
